      ...
      <div class="text-container">
        ...
        <div :style="isDarkMode ? { color: 'white' } : null">
          ...
          <p class="snippet">
            ...
            in. Obcaecati in iusto minima impedit assumenda perferendis natus
            tempore modi ducimus. Blanditiis, quis. Maxime delectus ducimus
            assumenda vel accusantium, eligendi nobis accusamus fuga, hic, natus
            ab odit. Earum, eveniet magnam perspiciatis similique odit
            cupiditate optio aut fugit, inventore, dolorem id?
          </p>
        </div>
      </div>
      <img
